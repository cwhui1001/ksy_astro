  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] group">
      ...
      <div className="absolute bottom-full right-0 mb-4 opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none translate-y-2 group-hover:translate-y-0">
        <div className="bg-white text-primary font-bold px-4 py-2 rounded-xl shadow-2xl border border-primary/10 whitespace-nowrap text-sm">
          Chat with us on WhatsApp!
        </div>
        {/* Triangle tip */}
        <div className="absolute top-full right-6 w-3 h-3 bg-white border-r border-b border-primary/10 rotate-45 -translate-y-1.5" />
      </div>

      {/* Pulse Rings */}
      <div className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-20 group-hover:opacity-0 transition-opacity" />
      <div className="absolute inset-0 rounded-full bg-[#25D366] animate-pulse opacity-40 group-hover:opacity-0 transition-opacity" />
